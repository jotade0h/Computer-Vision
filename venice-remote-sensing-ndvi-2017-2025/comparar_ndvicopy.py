...
# 📁 Rutas a las carpetas SAFE
carpeta_2017 = "data/S2A_MSIL2A_20170124T101311_N0500_R022_T32TQR_20231026T122958.SAFE"
carpeta_2025 = "data/S2B_MSIL2A_20250127T101209_N0511_R022_T32TQR_20250127T130241.SAFE"
...
ndvi_2017, profile_2017 = calcular_ndvi(b08_2017_path, b04_2017_path)

print("🧮 Calculando NDVI 2025...")
ndvi_2025, profile_2025 = calcular_ndvi(b08_2025_path, b04_2025_path)
...
im1 = axes[0].imshow(ndvi_2017, cmap='RdYlGn', vmin=-1, vmax=1)
...
plt.subplot(1, 3, 1)
plt.title("NDVI 2017")
plt.imshow(ndvi_2017, cmap='RdYlGn', vmin=-0.2, vmax=0.2)
plt.colorbar()

plt.subplot(1, 3, 2)
plt.title("NDVI 2025")
plt.imshow(ndvi_2025, cmap='RdYlGn', vmin=-0.2, vmax=0.2)
plt.colorbar()

plt.subplot(1, 3, 3)
plt.title("Diferencia NDVI")
plt.imshow(ndvi_2025 - ndvi_2017, cmap='seismic', vmin=-0.2, vmax=0.2)
plt.colorbar()

plt.tight_layout()
plt.savefig("data/comparacion_ndvi_sensible.png")
plt.show()
...
# 💾 Guardar resultados
print("💾 Guardando resultados en carpeta 'data/'...")
os.makedirs("data", exist_ok=True)

# Actualizar perfil
profile = profile_2017

# Actualiza el profile
profile.update(
    dtype=rasterio.float32,
    count=1,
    driver='GTiff'  # Asegúrate de que estás usando GeoTIFF
)

# Guarda NDVI 2017
with rasterio.open("data/ndvi_2017.tif", "w", **profile) as dst:
    dst.write(ndvi_2017.astype(rasterio.float32), 1)

# Guarda NDVI 2025
with rasterio.open("data/ndvi_2025.tif", "w", **profile) as dst:
    dst.write(ndvi_2025.astype(rasterio.float32), 1)
diferencia_ndvi = ndvi_2025 - ndvi_2017
with rasterio.open("data/diferencia_ndvi.tif", "w", **profile) as dst:
    dst.write(diferencia_ndvi.astype(rasterio.float32), 1)

# Guardar PNGs
plt.imsave("data/ndvi_2017.png", ndvi_2017, cmap='RdYlGn', vmin=-1, vmax=1)
plt.imsave("data/ndvi_2025.png", ndvi_2025, cmap='RdYlGn', vmin=-1, vmax=1)
plt.imsave("data/diferencia_ndvi.png", diferencia_ndvi, cmap='RdYlGn', vmin=-1, vmax=1)

print("✅ Todo guardado correctamente en 'data/'")
